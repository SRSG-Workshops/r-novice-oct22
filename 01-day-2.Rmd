...
> ### Stretch Challenge {.challenge}
>
>  Rewrite the code below using as few lines of code as possible and using pipes 
...
> surveys_6 <- select(surveys_5, -day)
> 
> ```{r, answer=TRUE, eval=FALSE, purl=FALSE}
> surveys %>%
...
> at the [documentation for dplyr](https://github.com/rstudio/cheatsheets/raw/master/data-transformation.pdf)
> 
...
```{r, purl=FALSE}
surveys_gw %>%
  pivot_wider(genus, mean_weight, values_fill = 0) %>%
  head()
```
