...
## If you didnt finish the previous day (or are having problems with the data) run this to create the needed envronment.
...
> Hint: Have a look at the [**`ggplot2`** cheat sheet](https://github.com/rstudio/cheatsheets/raw/master/data-visualization-2.1.pdf) 
...
>
> ```{r scatter-challenge-answer, answer=TRUE, eval = FALSE, purl=FALSE}
> ggplot(data = surveys_complete, 
...
> 
> ```{r average-weight-time-series, answer=TRUE, eval=FALSE, purl=FALSE}
