...
## ## Thinking about the survey dataset, or another dataset you are fimilaiar with
## ## can you think of a use case for each of the functions baised on their discriptions above?
